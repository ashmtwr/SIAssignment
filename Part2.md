...
Assignment requires to load the ToothGrowth data and perform basic exploratory data analysis to;
- Provide a basic summary of the data.
- Use confidence intervals and/or hypothesis tests to compare tooth growth by supp and dose. (Use the techniques from class, even if there's other approaches worth considering)
...
## Develop ggplot based on the data
